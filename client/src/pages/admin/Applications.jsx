      ...
      <main className="min-h-screen bg-[#0f0c29] px-5 py-8 text-white sm:px-10">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mt-2 text-gray-400">
            Review and manage requests to host events on Eventora.
          </p>
            ...
            <div className="flex flex-wrap items-center gap-3 border-b border-white/10 p-4">
              ...
              <div className="ml-auto flex items-center gap-2 rounded-lg border border-white/10 bg-black/10 px-3 text-slate-400">
                ...
                <input
                  ...
                  className="w-40 bg-transparent py-2 text-sm text-white outline-none placeholder:text-slate-500"
                />
              </div>
              ...
              <button
                type="button"
                className="hidden items-center gap-2 rounded-lg border border-white/10 px-3 py-2 text-sm text-slate-300 hover:bg-white/10 sm:flex"
              >
                <Filter size={15} />
                Filter
              </button>
              ...
              <table className="w-full min-w-[900px] text-left text-sm">
                ...
                <tbody>
                  {visible.map((application) => (
                    ...
                    >
                      {/* Application ID */}
                      <td className="px-5 py-4 font-medium text-[#00ff85]">
                        #ORG-
                      ...
                      <td className="px-5 py-4 capitalize text-slate-300">
                        {application.organizer_type.toLowerCase()}
                      </td>
                      ...
                      <td className="px-5 py-4">
                        <div className="flex items-center gap-2">
                          <Link
                            ...
                            className="grid h-9 w-9 place-items-center rounded-lg border border-white/10 text-slate-300 hover:border-[#00ff85]/50 hover:text-[#00ff85]"
                          >
                            <Eye size={16} />
                          </Link>
                          ...
                          <button
                            ...
                            className="grid h-9 w-9 place-items-center rounded-lg border border-white/10 text-slate-400 hover:bg-white/10"
                          >
