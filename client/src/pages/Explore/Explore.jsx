        ...
        <div className="mx-auto max-w-7xl">
          <section className="flex flex-wrap items-end justify-between gap-8 py-10 sm:py-14">
            <div>
              ...
              <p className="mt-4 max-w-xl text-base leading-relaxed text-slate-400">
                Find events, workshops, and experiences happening around you.
              </p>
            </div>

            <div className="hidden rounded-2xl border border-white/10 bg-white/[0.04] p-5 sm:block">
              <SlidersHorizontal
          ...
          <section className="rounded-2xl border border-white/10 bg-white/[0.04] p-3 shadow-xl sm:p-4">
            <div className="flex flex-col gap-3 lg:flex-row">
              ...
              <label className="flex flex-1 items-center gap-3 rounded-xl border border-white/10 bg-[#0d1418] px-4 text-slate-400">
                <Search size={18} />
              ...
              <button
                type="button"
                className="rounded-xl bg-[#00ff85] px-6 py-3 text-sm font-semibold text-black transition hover:bg-[#00d970]"
              >
                Search
              </button>
          ...
          <div className="mt-7 flex items-center justify-between">
            ...
            {isOrganizer && (
              <Link
                to="/events/add"
                className="inline-flex items-center gap-2 rounded-xl bg-[#00ff85] px-4 py-2.5 text-sm font-semibold text-black transition hover:bg-[#00d970]"
              >
          ...
          <section className="mt-5">
            {loading ? (
              <div className="grid min-h-80 place-items-center rounded-2xl border border-dashed border-white/10 text-slate-400">
                Loading events...
              </div>
            ) : visibleEvents.length === 0 ? (
              <div className="grid min-h-80 place-items-center rounded-2xl border border-dashed border-white/10 bg-white/[0.02] p-10 text-center">
                <div>
                  <div className="mx-auto grid h-16 w-16 place-items-center rounded-2xl bg-[#00ff85]/10 text-[#00ff85]">
                  ...
                  <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-400">
                    ...
                    Check back soon for new Eventora experiences.
                  </p>
